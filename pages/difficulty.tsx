...
export default function Difficulty(): JSX.Element {
  ...
  return (
    <Layout activePath="difficulty">
      <TaskCollection data={easyList} title="Easy" type="upcoming" />
      <TaskCollection data={mediumList} title="Medium" type="upcoming" />
      <TaskCollection data={difficultList} title="Difficult" type="upcoming" />
    </Layout>
  );
}
